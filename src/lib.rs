...
extern crate euclid;
extern crate image;
pub extern crate livesplit_core as core;
extern crate lyon;
extern crate ordered_float;
extern crate rusttype;
extern crate title_abbreviations;
...
struct RenderContext<'b, B: Backend + 'b> {
    transform: Transform,
    backend: &'b mut B,
...
impl<'b, B: Backend + 'b> RenderContext<'b, B> {
    ...
    fn render_info_text_component(
        ...
        let mut end_x = self.render_text_right_align(
            value,
...
fn render_timer_component(
    context: &mut RenderContext<impl Backend>,
